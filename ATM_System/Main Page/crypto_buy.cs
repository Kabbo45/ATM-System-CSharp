...
{
    public partial class crypto_buy : Form
    {
        ...
        public void data()
        {
            ...
            cmd.CommandText = "SELECT username, wallet_ad, amount_bought, currency, transaction_id, date FROM crypto_history WHERE username = '" + cc + "'";
                        ...
                        if (m == "Bitcoin")
                        {
                            ...
                            else
                            {
                                ...
                                if (result == DialogResult.OK)
                                {
                                    ...
                                    cmd5.CommandText = "INSERT INTO crypto_history (username, account_type, wallet_ad, amount_bought, currency, transaction_id, date) VALUES(@username, @account_type, @wallet_ad, @amount_bought, @currency, @transaction_id, @date)";
